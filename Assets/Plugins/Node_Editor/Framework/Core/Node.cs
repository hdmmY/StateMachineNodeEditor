...
namespace NodeEditorFramework
{
    ...
    public abstract partial class Node : ScriptableObject
    {
        ...
        /// Hide title GUI.
        /// </summary>
        public virtual bool HideTitle { get { return false; } }

        /// <summary>
        /// Specifies the node title color
        /// </summary>
        public virtual Color TitleColor { get { return Color.white; } }
        ...
        protected internal virtual void DrawNode ()
        {
            ...
            GUI.color = Color.white;
            bodyRect.position = new Vector2 (3, 3);
