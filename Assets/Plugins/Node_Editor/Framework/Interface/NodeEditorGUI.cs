...
namespace NodeEditorFramework
{
    ...
    public static partial class NodeEditorGUI
    {
        ...
        public static bool Init ()
        {
            ...
            nodeLabelCentered = new GUIStyle (nodeLabel) { alignment = TextAnchor.MiddleCenter, fontSize = 15 };
            nodeLabelBoldCentered = new GUIStyle (nodeLabelBold) { alignment = TextAnchor.MiddleCenter, fontSize = 15 };
