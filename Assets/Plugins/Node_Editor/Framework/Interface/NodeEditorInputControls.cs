...
namespace NodeEditorFramework
{
    ...
    public static class NodeEditorInputControls
    {
        ...
        [ContextEntry (ContextType.Node | ContextType.StateNode, "Delete Node")]
        ...
        [ContextEntry (ContextType.Node | ContextType.StateNode, "Duplicate Node")]
        ...
        [ContextEntry (ContextType.StateNode, "Add In Connection")]
        private static void AddInConnection (NodeEditorInputInfo inputInfo)
        {
            inputInfo.SetAsCurrentEnvironment ();
                ...
                state.focusedNode.GetType () == typeof (StateNode))
            {
                ...
                node.CreateConnectionKnob (node.StateTransInAttribute);
            }
        }

        [ContextEntry (ContextType.StateNode, "Add Out Connection")]
        ...
        [ContextEntry (ContextType.StateNode, "Set As Default")]
        ...
        [ContextEntry (ContextType.StateConnectKnob, "Remove Connection")]
        ...
        [HotkeyAttribute (KeyCode.W, EventType.KeyDown)]
        [HotkeyAttribute (KeyCode.A, EventType.KeyDown)]
        [HotkeyAttribute (KeyCode.S, EventType.KeyDown)]
